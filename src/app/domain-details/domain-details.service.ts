...
export class DomainDetailsService {
  ...
  constructor(
    ...
    this.handleError = httpErrorHandler.createHandleError('DomainDetailsService');
  }
  ...
  getDomain(id: string): Observable<Domain> {
    ...
    return this.http.get<Domain>(this.domainsUrl + "/" + id, options)
      .pipe(
        catchError(this.handleError<Domain>('getDomain'))
      );
  }
}
